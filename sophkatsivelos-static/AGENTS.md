...
- Keep the Archive project browser and its selected-record preview directly adjacent at desktop and laptop widths; only stack the preview below the browser in the dedicated mobile layout.
